...
#     model.add(tf.keras.layers.Dense(24, input_shape=state_shape, activation='relu', kernel_initializer='HeUniform'))
#     model.add(tf.keras.layers.Dense(12, activation='relu', kernel_initializer='HeUniform'))
#     model.add(tf.keras.layers.Dense(action_shape, activation='linear', kernel_initializer='HeUniform'))
